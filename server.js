...
3. Arraste esses 2 arquivos para a área de upload do GitHub
4. Em "Commit changes", escreva: `Código inicial da API WhatsApp`
5. Clique em **"Commit changes"**

### 5️⃣ Agora volte ao Render (segunda imagem)

No campo que está vazio:
```
https://github.com/uberdomatuto/whatsapp-lembretes
